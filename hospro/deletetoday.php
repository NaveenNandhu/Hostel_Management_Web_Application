...
if (isset($_POST['deletetdybtn'])) {
    ...
    $sql = "SELECT `$today[0]` FROM `purchase_stock` WHERE `S.No`=$id";
    ...
    $sql4 = "UPDATE `purchase_stock` SET `$today[0]`='$zero' WHERE `S.No`='$id'";
    $result4 =  $connection->query($sql4);
    header("Location: grocerypurc.php?dateinput=$today[0]&fetchbtn=");
        ob_clean();
}
?>