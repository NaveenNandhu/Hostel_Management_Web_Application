...
<body>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Taken Quantity</h5>
                </div>
                <form method="get">
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" id="quanidinput" placeholder="Quantity"
                            name="updatequan" required id="inputName">
                        <script>
        ...
        <div class="container-fluid">
            ...
            <div class="dropdown" style="position: absolute; right: 30px;">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <a class="dropdown-item" href="monthlystock.php" target="_blank">Monthly Stock</a>
                    <a class="dropdown-item" href="grocerypurc.php" target="_blank">Grocery Purchase</a>
                    <a class="dropdown-item active" href="#">Daily Stock</a>
                    <a class="dropdown-item" href="filteritems.php" target="_blank">Filter Stock</a>
    ...
    <br>
    <center>
        <h3 style="user-select: none; cursor: pointer;">Daily Stock</h3>
    </center>
        ...
        <table class="table table-hover table-bordered">
            <thead>
                <tr>
                    ...
                    <th scope="col">
                        <center>Entries</center>
                    </th>
                </tr>
            </thead>
            <tbody>
                <?php
                include 'fetchforminus.php';
                include 'minusitems.php';
                ?>
            </tbody>
        </table>
    </div>
